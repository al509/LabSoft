...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(737, 501)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.LaserControlBox = QtWidgets.QGroupBox(self.centralwidget)
        self.LaserControlBox.setGeometry(QtCore.QRect(290, 180, 361, 221))
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(30, 19, 321, 247))
        self.formLayoutWidget.setObjectName("formLayoutWidget")
        self.LaserControlLayout = QtWidgets.QFormLayout(self.formLayoutWidget)
        self.LaserControlLayout.setFieldGrowthPolicy(QtWidgets.QFormLayout.AllNonFixedFieldsGrow)
        self.LaserControlLayout.setRowWrapPolicy(QtWidgets.QFormLayout.DontWrapRows)
        self.LaserControlLayout.setContentsMargins(0, 0, 0, 0)
        self.LaserControlLayout.setVerticalSpacing(6)
        ...
        self.LaserControlLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.NumberOfCycleLabel)
        ...
        self.LaserControlLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.NumberOfCycleField)
        self.TurnLaserOnButton = QtWidgets.QPushButton(self.formLayoutWidget)
        self.TurnLaserOnButton.setCheckable(True)
        self.TurnLaserOnButton.setObjectName("TurnLaserOnButton")
        self.LaserControlLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.TurnLaserOnButton)
        self.MoveOutButton = QtWidgets.QPushButton(self.formLayoutWidget)
        self.MoveOutButton.setObjectName("MoveOutButton")
        self.LaserControlLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.MoveOutButton)
        self.LaserPower = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.LaserPower.setObjectName("LaserPower")
        self.LaserControlLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.LaserPower)
        self.OpenShutter = QtWidgets.QPushButton(self.formLayoutWidget)
        self.OpenShutter.setCheckable(True)
        self.OpenShutter.setObjectName("OpenShutter")
        self.LaserControlLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.OpenShutter)
        ...
        self.ConnectionBox.setGeometry(QtCore.QRect(50, 30, 221, 141))
        self.ConnectionBox.setObjectName("ConnectionBox")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.ConnectionBox)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(10, 19, 191, 149))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.TurnLaserOnButton.setText(_translate("MainWindow", "Set Laser On"))
        self.MoveOutButton.setText(_translate("MainWindow", "Move out"))
        self.LaserPower.setText(_translate("MainWindow", "5"))
        self.OpenShutter.setText(_translate("MainWindow", "Open shutter"))
